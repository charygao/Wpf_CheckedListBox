...
{
    public abstract class CheckListBoxBase : ListBox, ICheckCtrlBase
    {
        #region members
        ...
        public CheckListBoxBase(bool isRadioMode) : base()
        {
        ...
        private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            BindingExpression   _bindExp  = this.GetBindingExpression(CheckListBoxBase.CheckedValueProperty);
        ...
        public static readonly DependencyProperty CheckedValueProperty = DependencyProperty.Register("CheckedValue", typeof(object), typeof(CheckListBoxBase),
        ...
        private static void OnCheckedValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            CheckListBoxBase _ctrl  = (CheckListBoxBase)d;
